...
class SuperPointNet_ac(torch.nn.Module):
    """ Pytorch definition of SuperPoint Network. """

    def __init__(self, deploy=False):
        super(SuperPointNet_ac, self).__init__()
        ...
        # self.conv4 = ACBlock(c3, c4, kernel_size=3, padding=1, stride=1, deploy=False)
...
if __name__ == '__main__':
    main('ac.pth.tar','./weight/LEFPD_AC_weight')